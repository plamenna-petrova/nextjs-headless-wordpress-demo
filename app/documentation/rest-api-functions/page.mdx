...
# Използвани функции на приложно-програмния интерфейс на WordPress в прогресивното приложение
...
<Row>
  <Col>
    ...
    - Тя извлича данните от приложно-програмния интерфейс на WordPress.
