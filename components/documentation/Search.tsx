...
function SearchResult({
  ...
  let sectionTitle: string | undefined = navigationGroups.find((navigationGroup) =>
    navigationGroup.links.find((link) => link.href === result.url.split('#')[0]),
  )?.title;

  let hierarchy: string[] = [sectionTitle, result.pageTitle].filter(
